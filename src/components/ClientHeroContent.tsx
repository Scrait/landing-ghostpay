// src/components/ClientHeroContent.tsx
'use client';

import { useEffect, useRef } from 'react';
import { Ghost } from 'lucide-react';

export default function ClientHeroContent() {
  ...
  return (
    <div className="container mx-auto px-4 flex flex-col text-center relative z-10">
      ...
      <div className="absolute top-[106%] left-1/2 -translate-x-1/2">
        <div className="relative w-6 h-12 border-2 border-neon-blue rounded-full p-1">
          <div className="w-3 h-2 bg-neon-blue rounded-full animate-scroll-down"></div>
        </div>
      </div>
    </div>
  );
