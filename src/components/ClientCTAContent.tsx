// src/components/ClientCTAContent.tsx
'use client';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(-45deg, rgba(0,255,255,0.2), rgba(138,43,226,0.2), rgba(0,255,127,0.2))',
      ...
      <div className="relative z-10 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-orbitron font-bold mb-6">
          Start Your Ghost Wallet{' '}
          <span className="text-neon-purple glow-text-purple">Today</span>
        </h2>

        <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 text-white/90">
          Take control of your group finances with secure, transparent, and
          democratic fund management. No intermediaries, no trust issues.
        </p>

        <div className="flex flex-col sm:flex-row gap-5 justify-center">
          <a href="#" className="ghost-button text-lg group font-bold px-10 py-4">
            Launch App
          </a>
